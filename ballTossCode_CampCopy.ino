...
const float T_0 = (?) + 273; // initial temperature needs to be googled (?°C + 273 to convert to kelvin)
const float R   = ?;         // normalized gas constant for earths atmosphere (J/(mol*K) [8.315/(29*10^-3)]
const float g   = ?;         // acceleration due to gravity with 3 significant figures (m/s^2)
//---------------------------------------------//
